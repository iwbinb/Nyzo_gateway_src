...
function timeDelayProgressbar($percentage_tx_delay, $mins_tx_delay_float, $percentage_tx_confirm, $mins_after_delay)
{
  ...
  <div class="progress-bar bg-success" style="width:';
    echo $percentage_tx_confirm;
    echo '%">Available confirmation time: ';
